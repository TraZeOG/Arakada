...
bouton_start = Bouton(screen_width // 2 - 130, screen_height // 2 - 40, 260, 100, pygame.image.load("sprites/img_bouton_start.webp"))
bouton_restart = Bouton(screen_width // 2 - 130, screen_height // 2 + 120, 260, 100, pygame.image.load("sprites/img_bouton_restart.webp"))
...
while run:
    ...
    if menu_principal == True:
        ...
        draw_text("Arakada games", font_lilitaone_70, clr_black, screen_width // 2, screen_height // 2 - 280)
