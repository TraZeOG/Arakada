...
img_background_play = pygame.image.load("sprites/img_background_play.webp")
img_coeur_on = pygame.image.load("sprites/img_coeur_on.webp")
img_background_area = pygame.image.load("sprites/img_background_area.webp")
img_background_area = pygame.transform.scale(img_background_area, (screen_width, 2))
img_joueur = pygame.image.load("sprites/img_joueur.webp")
img_citron= pygame.image.load("sprites/img_citron.webp")

img_coeur_off = pygame.image.load("sprites/img_coeur_off.webp")
font_bauhaus_50 = pygame.font.SysFont("Bauhaus 93", 50)
font_bauhaus_30 = pygame.font.SysFont("Bauhaus 93", 30)
font_lilitaone_70 = pygame.font.Font("fonts/LilitaOne-Regular.ttf", 80)
...
class Object(pygame.sprite.Sprite):
    def __init__(self, groupe, type):
        ...
        self.type = type
        if groupe == "ennemi":
            self.image = pygame.image.load(f"sprites\img_bombe.webp")
        if groupe == "friendly":
            self.image = pygame.image.load(f"sprites\img_friendly.webp")
        if type == "zigzag":
            self.image = pygame.image.load(f"sprites\img_cerise.webp")
            self.image = pygame.transform.scale(self.image, (50,50))
            self.counter = 0
            self.direction = 2
        if type == "normal" or type == "speed":
            self.image = pygame.image.load(f"sprites\img_citron.webp")
            self.image = pygame.transform.scale(self.image, (70,70))
        if type == "gros":
            self.image = pygame.image.load(f"sprites\img_ananas.webp")
