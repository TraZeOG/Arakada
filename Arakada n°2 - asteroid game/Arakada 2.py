...
img_background_summary = pygame.image.load("sprites/img_background_summary.webp")
img_meteorite = pygame.image.load("sprites/img_meteorite_menu.webp")
img_joueur = pygame.image.load("sprites/img_citron_menu.webp")
...
class Object(pygame.sprite.Sprite):
    def __init__(self, type, cote, xx, yy):
        ...
        self.image = pygame.image.load("sprites/img_meteorite.webp")
        if type == "zigzag" or type == "speed":
            self.image = pygame.image.load("sprites/img_soucoupe.webp")
